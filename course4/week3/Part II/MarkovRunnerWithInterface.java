...
public class MarkovRunnerWithInterface {
    ...
    public void compareMethods() {
        ...
        System.out.println("EMM starts at: " + System.nanoTime());
        EfficientMarkovModel emm = new EfficientMarkovModel(2);
        runModel(emm, st, size, seed);
        System.out.println("EMM ends and MM starts at: " + System.nanoTime());
        MarkovModel mThree = new MarkovModel(2);
        runModel(mThree, st, size, seed);
        System.out.println("MM starts at: " + System.nanoTime());
    }
}
